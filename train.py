...
if 'AMLT_DATA_DIR' in os.environ:
    configuration['train_path'] = os.path.join(os.environ['AMLT_DATA_DIR'],'wiki.train.tokens')
    configuration['validation_path'] = os.path.join(os.environ['AMLT_DATA_DIR'],'wiki.valid.tokens')
